...
function MainQuestion() {
  ...
  return (
    <div className='main'>
      <div className="main-container">
        ...
        <div className="all-questions">
          <div className="all-questions-container">
            ...
            <div className="question-answer" style={{ width: "50vw" }}>
              <p>{htmlParser.parse(questionData?.body)}</p>
              ...
              <div className="comments">
                  ...
                  {questionData?.comments &&
                    questionData?.comments.map((_qd) => (
                      <p key={_qd?._id}>
                        {_qd.comment}{" "}
                        <span>
                          - {_qd.user ? _qd.user.displayName :  String(_qd?.user?.email).split("@")[0]}
                        </span>{" "}
                        {"    "}
                        <small>
                ...
                <p onClick={() => setShow(!show)}>Add a comment</p>{
                  show && (<div className='title'>
                    ...
                    <button onClick={handelComment} style={{
          ...
          }}>{questionData?.answerDetails?.length}</p>
          {
            questionData?.answerDetails?.map((_q) => (<div key={_q?._id} className="all-questions-container">
              ...
              <div className="question-answer">
                <p>{htmlParser.parse(_q?.answer)}</p>
              </div>
              <div className="author">
      ...
      <button type='submit' onClick={handelSubmit} style={{ maxWidth: "fit-content", marginTop: "50px" }}>Post Your Answer</button>
    </div>
  )
}
